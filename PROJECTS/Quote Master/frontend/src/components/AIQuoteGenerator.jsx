...
//   const quoteRef = useRef(null); // Ref for the quote div

//   const generateAIQuote = async () => {
//     setIsLoading(true);
//     setGeneratedQuote(null);

//     const apiKey = 'sk-proj-iPRsrdPubpA6qLsEstcST3BlbkFJKrOy4yGCjrDFzb3UDL3z';
...
//             {
//               role: 'user',
//               content: `Generate a short, inspiring quote about ${topic}.`,
//             },
//           ],
//         }),
//       });
...
//     if (quoteRef.current) {
//       try {
//         const canvas = await html2canvas(quoteRef.current, { scale: 2 }); // Increase scale for better resolution
...
//             <input
//               type="text"
//               placeholder="Enter a topic for your quote"
//               value={topic}
...
//               <div
//                 ref={quoteRef}
//                 className="mt-4 p-4 bg-gray-100 rounded-lg relative flex flex-col items-center justify-center"
//                 style={{
...
//                   </blockquote>
//                 </div>
//                 <p className="text-center">- {generatedQuote.author}</p>
//                 <Button variant="outline" className="mt-2" onClick={downloadQuoteImage}>
//                   Download Quote
//                 </Button>
//               </div>
//             )}
